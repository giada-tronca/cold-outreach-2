...
const logger = {
    ...
    warn: (message, data) => {
        console.warn(`[DATABASE WARNING] ${message}`, data ? JSON.stringify(data, null, 2) : '');
    }
};
