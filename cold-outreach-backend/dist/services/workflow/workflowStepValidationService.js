...
exports.WorkflowStepValidationService = void 0;
class WorkflowStepValidationService {
    /**
     * Validate step configuration
     */
    static validateStep(step, configuration) {
     ...
     */
    static validateTransition(from, to, configuration) {
     ...
     * Get step definition
     */
    static getStepDefinition(step) {
        return this.stepDefinitions[step];
    }
    /**
     * Get step configuration based on step type
     */
    static getStepConfiguration(step, configuration) {
        switch (step) {
            case 'UPLOAD_CSV':
...
exports.WorkflowStepValidationService = WorkflowStepValidationService;
WorkflowStepValidationService.stepDefinitions = {
    'UPLOAD_CSV': {
        step: 'UPLOAD_CSV',
