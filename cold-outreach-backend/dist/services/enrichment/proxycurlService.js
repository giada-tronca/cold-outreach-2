...
class ProxycurlService {
     ...
     */
    static async enrichPersonProfile(linkedinUrl) {
        try {
     ...
     */
    static async generateLinkedInSummaryWithAI(profileData) {
        try {
     ...
     */
    static async generateSummaryWithAI(prompt, aiProvider) {
        try {
