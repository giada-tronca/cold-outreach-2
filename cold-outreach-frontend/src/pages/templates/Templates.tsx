    ...
    <div className='p-6'>
      ...
      <div className='grid gap-6 md:grid-cols-2 lg:grid-cols-3'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-sm text-muted-foreground mb-4'>
              "Hi &#123;firstName&#125;, I noticed you work at
              &#123;company&#125;..."
            </div>
            <Button variant='outline' size='sm'>
              Use Template
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Template for partnership opportunities
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className='text-sm text-muted-foreground mb-4'>
              "Hi &#123;firstName&#125;, I believe there's a great opportunity
              for our companies..."
            </div>
            <Button variant='outline' size='sm'>
              Use Template
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-sm text-muted-foreground mb-4'>
              "Hi &#123;firstName&#125;, thank you for taking the time to speak
              with me..."
            </div>
            <Button variant='outline' size='sm'>
              Use Template
